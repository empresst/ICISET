# experiments/run_paper_industry.py
"""
Experiment script for Paper Industry Load Consumption Dataset
...
config.HOUSEHOLD_CSV = "../data/paper_industry.csv"
config.TARGET_COL = "load"          # Change if your column name is different

print("🚀 Running Experiment: Paper Industry Load Consumption")
print("=" * 70)
